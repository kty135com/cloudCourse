...
<div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
        ...
        <volist name="list" id="vo">
            ...
            <tr>
                <td width="5%" style="text-align:left; padding-left:20px;">
                        ${status.index+1}
                </td>
                <td>${cct.clazz.className}</td>
                <td width="25%">${cct.course.courseName}</td>
                <td>
                    <div class="button-group"><a class="button border-main"
                                                 href="<%=basePath%>person/sign.do?classId=${cct.clazz.classId}&courseId=${cct.course.courseId}"><span
                            class="icon-edit"></span> 查看签到</a></div>
                </td>
            </tr>
            </c:forEach>
            <tr>
