...
<div class="leftnav">
    ...
    <ul>
        <li><a href="<%=basePath%>person/hwlist.do" target="right"><span
                class="icon-caret-right"></span>布置作业</a></li>
        <li><a href="<%=basePath%>person/signlist.do" target="right"><span
                class="icon-caret-right"></span>查询签到</a></li>
        <li><a href="<%=basePath%>person/coulist.do" target="right"><span class="icon-caret-right"></span>积分分配</a></li>
        <li><a href="<%=basePath%>person/giftlist.do" target="right"><span
                class="icon-caret-right"></span>奖品管理</a></li>
    </ul>
    <h2><span class="icon-pencil-square-o"></span>课堂互动</h2>
    <ul>
        <li><a href="<%=basePath%>person/dianming.do" target="right"><span
                class="icon-caret-right"></span>在线点名系统</a></li>
    </ul>
</div>
