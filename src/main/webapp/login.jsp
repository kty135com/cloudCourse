...
<head>
    ...
    <script>
        if ('${requestScope.codeError}' != ""
        ) {
            alert('${requestScope.codeError}');
        }
    </script>
    <script type=text/javascript>
        ...
        function changeImg(img) {
            img.src = "<%=basePath%>base/checkCode.do?i=" + i;
            i++;
        }
    </script>
</head>
...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="<%=basePath%>person/login.do" method="post">
                    ...
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        ...
                        <div class="form-group">
                            <div class="field">
                                ...
                                <img src="<%=basePath%>base/checkCode.do" alt="" width="100" height="32"
                                     class="passcode" style="height:43px;cursor:pointer;" onclick="changeImg(this)">
                            </div>
                        </div>
                    </div>
